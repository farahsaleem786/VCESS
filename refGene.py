...
class info:
    ...
    def __init__(self, root, f):
        ...
        title = Label(frame1, text="VCESS Retrieving Data from RefGene", font=("Times New Roman", 16, "bold", "italic"),
                      bg='#7877a5',
                      fg='white')
        ...
        title = Label(frame1, text="VCESS Retrieving Data from RefGene",
        ...
        Btn = Button(self.frametwo, text="https://genome.ucsc.edu/cgi-bin/hgTables",
        ...
        text = canvas.create_text(0, -2000,
                                  text=f"The RefGene database was created from the \n"
                                       f"UCSC database. RefGene specifies known human \n"
                                       f"protein-coding and non-protein-coding genes \n"
                                       f"taken from the NCBI RNA reference sequences \n"
                                       f"collection (RefSeq). If you would like to \n"
                                       f"annotate your variants to genes, you can use \n"
                                       f"the simpler refGene database. If you would like\n"
                                       f" to determine the exons that your variants are\n"
                                       f"in, use the refGene_exon database.",
        ...
        try:
            ...
            table['columns'] = ['ID', 'RefGene.GeneName']
...
class info2:
    def __init__(self, root, f):
        ...
        try:
            ...
            (es)
        self.root = root
        self.root.title('RefGene window')
        self.root.overrideredirect(False)
        ...
        Frame1.place(x=0, y=0, width=width, height=150)
        title = Label(Frame1, text="VCESS Retrieving Data from RefGene", font=("Times New Roman", 40, "bold", "italic"),
                      bg='#cb525d',
                      fg='white')
        ...
        idz_p= Label(self.frametwo, text=' '+str(len(geneName)), font=("Times New Roman", 14),
                     bg='white', fg='black')
        idz_p.place(x=200, y=85)
        try:
            if len(geneName) == len(ID):
                table1 = LabelFrame(self.frametwo, text="Retrieved Data (Genomic Version HG19)",
                                    font=('Times New Roman', 16, 'bold'),
                                    bg='white')  ################
                table1.grid(padx=0, pady=0)
            ...
            ######################################
            elif (len(geneName) != len(ID)) and (len(geneName) and len(ID)) !=0:
                table1 = LabelFrame(self.frametwo, text="Retrieved Data (Genomic Version HG19)",
                                    font=('Times New Roman', 16, 'bold'),
                                    bg='white')  ################
                table1.grid(padx=0, pady=0)
    ...
    def get_file(self):
        ...
        (path)
        path = path[::-1]
        header=['HGVS_ID','refGene.GeneName']
        l1 = []
        data1=[]
